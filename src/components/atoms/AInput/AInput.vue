...
<template>
    <div>
        <input
            class="rounded-ds-radii-xs border px-ds-ref-spacing-3 py-ds-ref-spacing-3 text-ds-font-label-large-font-size font-ds-font-label-large-font-weight leading-ds-font-label-large-line-height tracking-ds-font-label-large-letter-spacing transition-all duration-300 placeholder:text-ds-color-on-surface placeholder:opacity-ds-opacity-color-medium focus-visible:outline-ds-color-on-surface"
